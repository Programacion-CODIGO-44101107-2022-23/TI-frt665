...
int menu ();
void insertarpunto (tipoarray x, tipoarray y, int *numpuntos); //x, y, numpuntos son de entrada/salida
void listarpuntos (tipoarray x, tipoarray y, int numpuntos); //x, y, numpuntos son de entrada
void eliminarpunto (tipoarray x, tipoarray y, int *numpuntos); //x, y, numpuntos son de entrada/salida
void rectaregresion (tipoarray x, tipoarray y, int numpuntos); //x, y, numpuntos son de entrada
double mediavector (tipoarray a, int numpuntos); //a, numpuntos son de entrada
double calcularb (tipoarray x, tipoarray y, int numpuntos); //x, y, numpuntos son de entrada
double calcularcoeficiente (tipoarray x, tipoarray y, int numpuntos); //x, y, numpuntos son de entrada
